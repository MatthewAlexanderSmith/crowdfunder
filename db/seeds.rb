...
User.create(first_name: "Matthew", last_name: "Smith", username: "JohnnyFucktard", email: "msmithros@hotmail.com",
    password: "catfood9",
            password_confirmation: "catfood9" )

Project.create(name: Faker::Commerce.product_name, end_date: Time.current, funding_goal: 1000000,
               description: "This
is a serious
  project yo", owner_id: 1)

Project.find(1).rewards.create(name: "John Boy", price: 1000, number_available: 1, description: "This reward
  is awesome")

#
# @projects = []
# 10.times do
#   @projects << Project.create(name: Faker::Commerce.product_name, end_date: Time.current, funding_goal: 1000000,
#                              description: "This
# is a serious
#   project yo", owner_id: 1)
# end
...
#   Project.find(project.id).rewards.create(name: "John Boy", price: 1000, number_available: 1, description: "This reward
#   is awesome")
# end
#
# 5.times do
